  ...
  return (
    <section id="about" className="min-h-screen w-full">
      <div className="relative">
        {/* 上侧 */}
        <div className="w-full min-h-0 flex ml-60 my-16">
          {/* 左侧 */}
          <div
          ...
          >
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="font-bold lg:text-4xl md:text-2xl text-xl tracking-tight">
                关于我们
              </div>
            </div>
        ...
        {/* 下侧信息栏 */}
        <div className="absolute -bottom-40 left-156 w-[811.375px] ">
